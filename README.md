...
<p align="center">
  ✈️ A simple desktop flight reservation system built with **Python, Tkinter, and SQLite**.<br>
  Demonstrates GUI integration with a relational database for **CRUD operations**.
</p>
